...
pt" src="lib/respond.min.js"></script>
	...
	<form id="form" class="form form-horizontal" >
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value=""  id="goodsName" name="goodsName" required="required"  aria-required="true"  placeholder="请输入商品名称" onblur="add()" onfocus="remove()">
			</div>
		</div>
		<div class="row cl">
		...
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>价格计算单位：</label>
			<div class="formControls col-xs-8 col-sm-9"> <span class="select-box">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" name="marketPrice" id="marketPrice" placeholder="" value="" class="input-text"  required="required" style="width:90%" onblur="addPrivice(this)">
				元</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>优惠价格：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" name="price" id="marketPrice" placeholder="" value="" class="input-text"  required="required" style="width:90%" onblur="addPrivice(this)">
				元</div>
		</div>
		<div class="row cl">
...
function isNull(str) {
	...
	$("#article_save").click(function(){
		...
		$.post("../goods/saveProduct",$('#form').serialize(),function(data){
			alert(data.message);
