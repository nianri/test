...
<div class="page-container">
	...
	<div class="page-container">
	<span style="margin-left: 42px;margin-top:23px ">2017订单信息统计</span>
    ...
    $('#container').highcharts({
      ...
      /*   subtitle: {
        ...
        series: [{
            ...
            pointStart: Date.UTC(2017, 0, 01),
            data: [
                [Date.UTC(2017, 0, 01), 0.8569],  [Date.UTC(2017, 0, 04), 0.8821],[Date.UTC(2017, 0, 07), 0.8431],[Date.UTC(2017, 0, 09), 0.8451]/*,    0.8418, 0.8264,    0.8258, 0.8232,    0.8233, 0.8258,
