...
<header class="navbar-wrapper">
	<div class="navbar navbar-fixed-top">
		<div class="container-fluid cl"> <a class="logo navbar-logo f-l mr-10 hidden-xs" href="/aboutHui.shtml">XX后台管理系统</a> <a class="logo navbar-logo-m f-l mr-10 visible-xs" href="/aboutHui.shtml">XX后台管理系统</a> 
...
<aside class="Hui-aside">
	<div class="menu_dropdown bk_2">
		...
		<dl id="menu-product">
			...
			<dd>
				<ul>
					...
					<li><a data-href="../goods/goods" data-title="产品管理" href="javascript:void(0)">产品管理</a></li>
			</ul>
		</dd>
	</dl>
		<dl id="menu-comments">
		...
		<dl id="menu-comments">
			...
			<dd>
				<ul>
					<li><a data-href="${pageContext.request.contextPath}/coupon/showCoupon" data-title="评论列表" href="javascript:;">优惠券</a></li>
					<li><a data-href="feedback-list.html" data-title="意见反馈" href="javascript:void(0)">已领取的优惠券</a></li>
			</ul>
		</dd>
	</dl>
		<dl id="menu-member">
	...
	<dl id="menu-admin">
			<dt><i class="Hui-iconfont">&#xe62d;</i> 店铺信息设置<i class="Hui-iconfont menu_dropdown-arrow">&#xe6d5;</i></dt>
			<dd>
				<ul>
					<li><a data-href="../admin/uodateShopInfo" data-title="角色管理" href="javascript:void(0)">店铺资料修改</a></li>
			</ul>
		</dd>
	</dl>
		<dl id="menu-tongji">
		...
		<dl id="menu-system">
			<dt><i class="Hui-iconfont">&#xe62e;</i> 入驻审核<i class="Hui-iconfont menu_dropdown-arrow">&#xe6d5;</i></dt>
			<dd>
				<ul>
					<li><a data-href="${pageContext.request.contextPath}/admin/firstTrial" data-title="系统设置" href="javascript:void(0)">初审</a></li>
					<li><a data-href="${pageContext.request.contextPath}/admin/secondTrial" data-title="栏目管理" href="javascript:void(0)">复审</a></li>
