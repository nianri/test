...
<body>
	...
	<div class="menu_dropdown bk_2">	
		...
		<dl id="menu-picture">
			...
			<dd>
				<ul>
					<li><a	data-href="${pageContext.request.contextPath}/advertin/advertList"
							data-title="广告列表" href="javascript:void(0)">广告列表</a>
					</li>					 
				</ul>
			</dd>
		</dl>		
		...
		<dl id="menu-member">
			...
			<dd>
				<ul>
					<li><a data-href="${pageContext.request.contextPath }/member/memberList" data-title="会员列表" href="javascript:;">会员列表</a></li>
				</ul>
			</dd>
		</dl>
		<dl id="menu-member">
			<dt>
				<i class="Hui-iconfont">&#xe60d;</i> 积分商品<i class="Hui-iconfont menu_dropdown-arrow">&#xe6d5;</i>
			</dt>
			<dd>
				<ul>
		...
		<dl id="menu-product">
			...
			<dd>
				<ul>
 					<li><a data-href="${pageContext.request.contextPath }/shopOils/shopOilsList" data-title="产品列表" href="javascript:void(0)">产品列表</a></li>
				</ul>
			</dd>
		</dl>
		<dl id="menu-system">
		...
		<dl >
			...
			<dd>
				<ul>
 					<li><a data-href="${pageContext.request.contextPath }/sysUser/sysUserList" data-title="用户列表" href="javascript:void(0)">用户列表</a></li>
				</ul>
			</dd>
		</dl>
	</div>
	...
	<section class="Hui-article-box">
			...
			<div class="Hui-tabNav-wp">
				<ul id="min_title_list" class="acrossTab cl">
					<li class="active"><span title="我的油虎"
						data-href="../admin/welcome2X">我的油虎</span>
						<em></em>
					</li>
				</ul>
			</div>
		...
		<div id="iframe_box" class="Hui-article">
			<div class="show_iframe">
				...
				<iframe scrolling="yes" frameborder="0" src="welcome2X.html"></iframe>
			</div>
		</div>
	</section>
