	...
	jQuery(function($) {
		$('#showtable').bootstrapTable(	{
			...
			[
				...
				{field:'shopname',title:'加油站',width:100,sortable:false,align:"left",colspan:1,rowspan:2,valign:"middle"},
				{field:'oilscode',title:'产品编码',width:60,sortable:false,align:"center",colspan:1,rowspan:2,valign:"middle"},
				{field:'oilsname',title:'产品名称',width:50,sortable:false,align:"center",colspan:1,rowspan:2,valign:"middle"},
				{field:'sourceprice',title:'原价/升',width:50,sortable:false,align:"center",colspan:1,rowspan:2,valign:"middle"},
				{field:'sourceprice',title:'优惠价/升',sortable:false,align:"center",colspan:7,rowspan:1},
