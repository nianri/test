//(function( $ ){
    ...
    $(function() {
        ...
        uploader = WebUploader.create({
            ...
            chunked: false,
            chunkSize: 512 * 1024,
            server: "http://127.0.0.1:8080/NavyAdmin/upload/fileUpload",
            //server: "${base}/upload/fileUpload",
            // runtimeOrder: 'flash',
        ...
        uploader.on( 'uploadSuccess', function( file,response ) {
        	...
        	//$("#imagevalue").val("../../resources/UploaderImg/4.jpg");
        	$("#imagevalue").attr("src","../../"+response.imagepath);
        	console.log("${base}");
        	//console.log("${base}/"+response.imagepath);
        	//setState("pedding");
        	//removeFile();
        	//window.uploader = uploader;
        	//location.reload();
